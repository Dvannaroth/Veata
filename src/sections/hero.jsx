  ...
  return (
    ...
    <div className='container'>
      <div className='home-content'>
        ...
        <Link to="/veata/About" className="bg-[#81ba1e] text-cyan-950 px-6 py-3 rounded-md text-lg hover:bg-cyan-700 hover:text-white transition duration-300">Discover</Link>
        <Link to="/veata/About" className="bg-[#81ba1e] text-cyan-950 px-6 py-3 rounded-md text-lg hover:bg-cyan-700 hover:text-white transition duration-300">Reservation</Link>
        </div>
    ...
    <div class="mt-8 grid grid-cols-1 px-10 md:grid-cols-2 lg:grid-cols-3 md:px-0 gap-8">
                <div class="bg-[#03465a] p-6 rounded-lg shadow-md hover:shadow-xl transition duration-300 text-center">
