  ...
  return (
    ...
    <Navbar />
      ...
      <div class="flex flex-col items-center mt-12 mb-12">
        <h1 className='text-amber-50 text-xl font-bold mb-8'>Why Choose Us?</h1>
    ...
    <img class="rounded-[24px]" src={hero} alt="" />
       ...
       <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
                <div>
          <h1 class="font-bold mb-4">Our Mission</h1>
        <p>Our mission is to provide an exceptional dining experience that delights the senses and creates lasting memories. We are committed to offering the highest quality food, impeccable service, and a welcoming ambiance, all while showcasing the beauty of Phnom Penh from our unique vantage point.</p>
        </div>
        <div>
    <img class="rounded-[24px]" src={hero} alt="" />
        </div>
